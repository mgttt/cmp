 ...
 * almost all functionality with simple calls.
 *
	...
	class FacadeNonStaticCmp43
{
	...
	public function selectDatabase( $key )
	{
		...
		if ( !isset( $this->toolboxes[$key] ) ) {
			throw new RedException( 'Database not found in registry. Add database using $this->addDatabase().' );
		}
	...
	*/
	 ...
	 *
	 * Usage:
	 * list( $author, $bio ) = $this->loadMulti( 'author, bio', $id );
	 *
